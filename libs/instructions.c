...
instruction instructions[0x100] = {
    ...
    [0xC6] = {IN_ADD, AM_R_D8, RT_A, RT_NONE, CT_NONE, 0},
    ...
    [0xD6] = {IN_SUB, AM_R_D8, RT_A, RT_NONE, CT_NONE, 0},
    ...
    [0xDE] = {IN_SBC, AM_R_D8, RT_A, RT_NONE, CT_NONE, 0},
    ...
    [0xE6] = {IN_AND, AM_R_D8, RT_A, RT_NONE, CT_NONE, 0},
    [0xE7] = {IN_RST, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0x20},
    [0xE8] = {IN_ADD, AM_R_D8, RT_SP, RT_NONE, CT_NONE, 0},
    ...
    [0xEE] = {IN_XOR, AM_R_D8, RT_A, RT_NONE, CT_NONE, 0},
    ...
    [0xF6] = {IN_OR, AM_R_D8, RT_A, RT_NONE, CT_NONE, 0},
    [0xF7] = {IN_RST, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0x30},
    [0xF8] = {IN_LD, AM_HL_SPR, RT_HL, RT_SP, CT_NONE, 0},
    [0xF9] = {IN_LD, AM_R_R, RT_SP, RT_HL, CT_NONE, 0},
    [0xFA] = {IN_LD, AM_R_A16, RT_A, RT_NONE, CT_NONE, 0},
    [0xFB] = {IN_EI, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0},
    [0xFC] = {IN_NONE, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0},
    [0xFD] = {IN_NONE, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0},
    [0xFE] = {IN_CP, AM_R_D8, RT_A, RT_NONE, CT_NONE, 0},
