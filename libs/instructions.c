...
instruction instructions[0x100] = {
    ...
    [0xC1] = {IN_POP, AM_IMP, RT_BC, RT_NONE, CT_NONE, 0},
    ...
    [0xE1] = {IN_POP, AM_IMP, RT_HL, RT_NONE, CT_NONE, 0},
    [0xE2] = {IN_LD, AM_MR_R, RT_C, RT_A, CT_NONE, 0},
    [0xE5] = {IN_PUSH, AM_IMP, RT_HL, RT_NONE, CT_NONE, 0},
    [0xE7] = {IN_RST, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0x20},
    [0xE9] = {IN_JP, AM_MR, RT_HL, RT_NONE, CT_NONE, 0},
    ...
    [0xF1] = {IN_POP, AM_IMP, RT_AF, RT_NONE, CT_NONE, 0},
    [0xF2] = {IN_LD, AM_R_MR, RT_A, RT_C, CT_NONE, 0},
    [0xF3] = {IN_DI, AM_IMP, RT_NONE, RT_NONE, CT_NONE, 0},
    [0xF5] = {IN_PUSH, AM_IMP, RT_AF, RT_NONE, CT_NONE, 0},
